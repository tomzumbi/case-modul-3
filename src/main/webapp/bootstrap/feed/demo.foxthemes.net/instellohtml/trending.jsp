...
<!-- Mirrored from demo.foxthemes.net/instellohtml/trending.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Dec 2022 04:42:52 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar_inner" data-simplebar>
                <div class="flex flex-col items-center my-6 uk-visible@s">
                    ...
                    <a href="profile.jsp" class="text-xl font-medium capitalize mt-4 uk-link-reset"> Stella Johnson
                    </a>
                    ...
                    <div class="uk-slider-container pb-3 lg:mr-3">
                        ...
                        <ul class="uk-slider-items uk-grid uk-grid-small">
                            ...
                            <li>
                                ...
                                <a href="/bootstrap/feed/demo.foxthemes.net/instellohtml/profile.jsp" class="block font-medium text-center text-gray-500 text-x truncate w-24">
                                    You </a>
                            </li>
                            <li>
                                <a href="#story-view" uk-toggle>
                                    <div
                                        ...
                                        <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/avatars/avatar-1.jpg"
                                            class="w-20 h-20 rounded-full border-2 border-white bg-gray-200">
                                    </div>
                                </a>
                                <a href="/bootstrap/feed/demo.foxthemes.net/instellohtml/profile.jsp" class="block font-medium text-center text-gray-500 text-x truncate w-24">
                            ...
                            <li>
                                <a href="#story-view" uk-toggle>
                                    <div
                                        class="bg-gradient-to-tr from-yellow-600 to-pink-600 p-1 rounded-full transform -rotate-2 hover:rotate-3 transition hover:scale-105 m-1">
                                        <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/avatars/avatar-3.jpg"
                                            class="w-20 h-20 rounded-full border-2 border-white bg-gray-200">
                                    </div>
                                </a>
                                <a href="/bootstrap/feed/demo.foxthemes.net/instellohtml/profile.jsp" class="block font-medium text-center text-gray-500 text-x truncate w-24">
                            ...
                            <li>
                                <a href="#story-view" uk-toggle>
                                    <div
                                        class="bg-gradient-to-tr from-yellow-600 to-pink-600 p-1 rounded-full transform -rotate-2 hover:rotate-3 transition hover:scale-105 m-1">
                                        <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/avatars/avatar-4.jpg"
                                            class="w-20 h-20 rounded-full border-2 border-white bg-gray-200">
                                    </div>
                                </a>
                                <a href="/bootstrap/feed/demo.foxthemes.net/instellohtml/profile.jsp" class="block font-medium text-center text-gray-500 text-x truncate w-24">
                            ...
                            <li>
                                <a href="#story-view" uk-toggle>
                                    <div
                                        class="bg-gradient-to-tr from-yellow-600 to-pink-600 p-1 rounded-full transform -rotate-2 hover:rotate-3 transition hover:scale-105 m-1">
                                        <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/avatars/avatar-5.jpg"
                                            class="w-20 h-20 rounded-full border-2 border-white bg-gray-200">
                                    </div>
                                </a>
                                </a>
                            ...
                            <li>
                                <a href="#story-view" uk-toggle>
                                    <div
                                        class="bg-gradient-to-tr from-yellow-600 to-pink-600 p-1 rounded-full transform -rotate-2 hover:rotate-3 transition hover:scale-105 m-1">
                                        <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/avatars/avatar-6.jpg"
                                            class="w-20 h-20 rounded-full border-2 border-white bg-gray-200">
                                    </div>
                                    <a href="/bootstrap/feed/demo.foxthemes.net/instellohtml/profile.jsp"
                        ...
                        <ul
                            ...
                            <li>
                                <div class="bg-gray-200 max-w-full lg:h-64 h-52 rounded-lg relative overflow-hidden">
                                    <a href="/bootstrap/feed/demo.foxthemes.net/instellohtml/profile.jsp">
                                        <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/post/img7.jpg"
                            ...
                            <li>
                                <div class="bg-gray-200 max-w-full lg:h-64 h-52 rounded-lg relative overflow-hidden">
                                    <a href="/bootstrap/feed/demo.foxthemes.net/instellohtml/profile.jsp">
                                        <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/avatars/avatar-7.jpg"
                                            class="w-full h-full absolute object-cover inset-0">
                                    </a>
                                    <a href="#" class="absolute right-3 top-3 bg-black bg-opacity-60 rounded-full"
                                        data-tippy-placement="left" title="Hide">
                ...
                <div class="mt-6 grid lg:grid-cols-3 grid-cols-2 gap-3 hover:text-yellow-700 uk-link-reset">
                    <div>
                        <div
                            ...
                            <a href="#story-modal" uk-toggle>
                                <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/post/img8.jpg"
                                    class="w-full h-full absolute object-cover inset-0">
                            </a>
                            <a href="#story-modal" uk-toggle
                                class="absolute flex h-full items-center justify-center w-8 w-full uk-transition-scale-up bg-black bg-opacity-10">
                                <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/icon-play.svg" alt="" class="w-16 h-16 -mt-5">
                            </a>
                            <div
                                class="flex flex-1 items-center absolute bottom-0 w-full p-3 text-white custom-overly1 uk-transition-slide-bottom-medium">
                                <a href="/bootstrap/feed/demo.foxthemes.net/instellohtml/profile.jsp" class="lg:flex flex-1 items-center hidden">
                                    <div
                    ...
                    <div>
                        <div
                            ...
                            <a href="#story-modal" uk-toggle>
                                <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/post/img2.jpg"
                                    class="w-full h-full absolute object-cover inset-0">
                            </a>
                            <div
                                class="flex flex-1 items-center absolute bottom-0 w-full p-3 text-white custom-overly1 uk-transition-slide-bottom-medium">
                    ...
                    <div>
                        <div
                            ...
                            <a href="#story-modal" uk-toggle>
                                <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/post/img3.jpg"
                                    class="w-full h-full absolute object-cover inset-0">
                            </a>
                            <a href="#story-modal" uk-toggle
                                class="absolute flex h-full items-center justify-center w-8 w-full uk-transition-scale-up bg-black bg-opacity-10">
                    ...
                    <div>
                        <div
                            ...
                            <a href="#story-modal" uk-toggle>
                                <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/post/img5.jpg"
                                    class="w-full h-full absolute object-cover inset-0">
                            </a>
                            <div
                                class="flex flex-1 items-center absolute bottom-0 w-full p-3 text-white custom-overly1 uk-transition-slide-bottom-medium">
                    ...
                    <div>
                        <div
                            class="bg-pink-400 max-w-full lg:h-72 h-48 rounded-lg relative overflow-hidden shadow uk-transition-toggle lg:-mt-12">
                            <a href="#story-modal" uk-toggle>
                                <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/post/img1.jpg"
                                    class="w-full h-full absolute object-cover inset-0">
                            </a>
                            <div
                                class="flex flex-1 items-center absolute bottom-0 w-full p-3 text-white custom-overly1 uk-transition-slide-bottom-medium">
                ...
                <div class="my-3 grid lg:grid-cols-4 grid-cols-2 gap-3 hover:text-yellow-700 uk-link-reset">
                    ...
                    <div>
                        <div
                            ...
                            <a href="#story-modal" uk-toggle>
                                <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/post/img2.jpg" class="w-full h-full absolute object-cover inset-0 scale-150 transform">
                            </a>
                            <div
                                class="flex flex-1 items-center absolute bottom-0 w-full p-3 text-white custom-overly1 uk-transition-slide-bottom-medium">
                                <a href="/bootstrap/feed/demo.foxthemes.net/instellohtml/profile.jsp" class="lg:flex flex-1 items-center hidden">
                    ...
                    <div>
                        <div
                            ...
                            <a href="#story-modal" uk-toggle>
                                <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/post/img6.jpg" class="w-full h-full absolute object-cover inset-0 scale-150 transform">
                            </a>
                            <div
                                class="flex flex-1 items-center absolute bottom-0 w-full p-3 text-white custom-overly1 uk-transition-slide-bottom-medium">
                    ...
                    <div>
                        <div
                            ...
                            <a href="#story-modal" uk-toggle>
                                <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/avatars/avatar-1.jpg" class="w-full h-full absolute object-cover inset-0">
                            </a>
                            <div
                                class="flex flex-1 items-center absolute bottom-0 w-full p-3 text-white custom-overly1 uk-transition-slide-bottom-medium">
                                <a href="#" class="lg:flex flex-1 items-center hidden">
        ...
        <div class="uk-modal-dialog story-modal">
            <button class="uk-modal-close-default lg:-mt-9 lg:-mr-9 -mt-5 -mr-5 shadow-lg bg-white rounded-full p-4 transition dark:bg-gray-600 dark:text-white" type="button" uk-close></button>
                ...
                <div class="story-modal-media">
                    <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/post/img4.jpg" alt=""  class="inset-0 h-full w-full object-cover">
                </div>
                <div class="flex-1 bg-white dark:bg-gray-900 dark:text-gray-100">
                        ...
                        <div class="py-4 ">
                            ...
                            <div class="flex items-center space-x-3"> 
                                <div class="flex items-center">
                                    <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/avatars/avatar-1.jpg" alt="" class="w-6 h-6 rounded-full border-2 border-white">
                                    <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/avatars/avatar-4.jpg" alt="" class="w-6 h-6 rounded-full border-2 border-white -ml-2">
                                    <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/avatars/avatar-2.jpg" alt="" class="w-6 h-6 rounded-full border-2 border-white -ml-2">
                                </div>
                                <div>
                    ...
                    <div class="-mt-1 space-y-1">
                        <div class="flex flex-1 items-center space-x-2">
                            <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/avatars/avatar-2.jpg" class="rounded-full w-8 h-8">
                        ...
                        <div class="flex flex-1 items-center space-x-2">
                            <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/avatars/avatar-4.jpg" class="rounded-full w-8 h-8">
                            <div class="flex-1 p-2">

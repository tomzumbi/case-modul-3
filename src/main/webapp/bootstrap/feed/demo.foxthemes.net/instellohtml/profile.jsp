            ...
            <div class="container pro-container m-auto">
                ...
                <div>
                    <div class="bg-red-500 max-w-full lg:h-64 h-40 rounded-md relative overflow-hidden uk-transition-toggle" tabindex="0"> 
                            <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/avatars/avatar-lg-1.jpg" class="w-full h-full absolute object-cover inset-0">
                    ...
                    <div>
                        <div class="bg-red-500 max-w-full lg:h-64 h-40 rounded-md relative overflow-hidden uk-transition-toggle" tabindex="0"> 
                            <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/post/img1.jpg" class="w-full h-full absolute object-cover inset-0">
                    ...
                    <div>
                        <div class="bg-red-500 max-w-full lg:h-64 h-40 rounded-md relative overflow-hidden uk-transition-toggle" tabindex="0"> 
                            <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/post/img4.jpg" class="w-full h-full absolute object-cover inset-0">
                    ...
                    <div>
                        <div class="bg-red-500 max-w-full lg:h-64 h-40 rounded-md relative overflow-hidden uk-transition-toggle" tabindex="0"> 
                            <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/avatars/avatar-6.jpg" class="w-full h-full absolute object-cover inset-0">
